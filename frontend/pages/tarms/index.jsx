...
const Tarms = () => {
  return (
    <div>
      <Meta title="Tarms || Blocklease.io | NFT Marketplace Next.js Template" />
        ...
        <section className="dark:bg-jacarta-800 relative py-16 md:py-24">
          ...
          <div className="container">
            ...
            <div className="article-content mx-auto max-w-[48.125rem]">
              ...
              <p>
                Blocklease.io is not a wallet provider, exchange, broker, financial
                institution, or creditor. Blocklease.io provides a peer-to-peer web3
              ...
              <p>
                ...
                including, without limitation, the Blocklease.io logo and all
                designs, text, graphics, pictures, data, software, sound files,
                other files, and the selection and arrangement thereof are the
                proprietary property of Blocklease.io or our affiliates, licensors,
              ...
              <p>
                ...
                Blocklease.io relating to your access to and use of the Service.
                ...
                consent of Blocklease.io, and Blocklease.io’s failure to assert any right
